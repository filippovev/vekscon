...
if ( isset( $_POST['sendMail'] ) ) {
  ...
  $body = "НАИМЕНОВАНИЕ ОРГАНИЗАЦИИ:\r\n".$company."\r\n\r\n";
  $body = "НАИМЕНОВАНИЕ ОРГАНИЗАЦИИ:\r\n".$data."\r\n\r\n";
  $body .= "РАЗМЕР ОБЕСПЕЧЕНИЯ ЗАЯВКИ НА УЧАСТИЕ:\r\n".$org."\r\n\r\n";
  $body .= "СТОИМОСТЬ ГОСКОНТРАКТА:\r\n".$gos."\r\n\r\n";
  $body .= "ДАТА ОКОНЧАНИЯ ПРИЕМА ЗАЯВОК:\r\n".$kon."\r\n\r\n";
...
{ 
  $subject = '=?UTF-8?B?'.base64_encode('Тендерный кредит').'?=';
...
<a href="http://www.vekscon.ru"><div id="glav"></div></a><div id="textraz"><span class="mail">ОФОРМЛЕНИЕ ЗАЯВКИ НА ТЕНДЕРНЫЙ КРЕДИТ</span><br /><br />
...
<br /><br />Наименование организации*<br>
	...
	<tr>
      <td align="left">Размер обеспечения заявки на участие<br><input type="text" name="org" maxlength="64" value="<?php echo $org ?>" /></td>
    </tr>
	<tr>
      <td>Дата окончания приема заявок<br><input type="text" name="kon" maxlength="64" value="<?php echo $kon ?>" /> </td>
    </tr>
	<tr>
      <td>Интернет ссылка на конкурс<br><input type="text" name="ssilka" maxlength="64" value="<?php echo $ssilka ?>" /></td>
    </tr>
	<tr>
      <td align="left">Тендерная документация<br><input type="file" name="file" /><br><br />
	  </td>
    </tr>
	</table></td>
    <td>&nbsp;</td>
