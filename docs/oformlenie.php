<?php
session_start();
$admin = 'inwiz@mail.ru, info@vekscon.ru';
...
if ( isset( $_POST['sendMail'] ) ) {
  ...
  $body = "НАИМЕНОВАНИЕ ОРГАНИЗАЦИИ:\r\n".$company."\r\n\r\n";
  $body = "НАИМЕНОВАНИЕ ОРГАНИЗАЦИИ:\r\n".$data."\r\n\r\n";
  $body .= "РАЗМЕР ОБЕСПЕЧЕНИЯ ИСПОЛНЕНИЯ ОБЯЗАТЕЛЬСТВ:\r\n".$org."\r\n\r\n";
  $body .= "СТОИМОСТЬ ГОСКОНТРАКТА:\r\n".$gos."\r\n\r\n";
  $body .= "ДАТА ЗАКЛЮЧЕНИЯ ГОСКОНТРАКТА:\r\n".$kon."\r\n\r\n";
  $body .= "ИНТЕРНЕТ ССЫЛКА НА КОНКУРС:\r\n".$ssilka."\r\n\r\n";
  $body .= "E-MAIL:\r\n".$email."\r\n\r\n";
  $body .= "ФАМИЛИЯ:\r\n".$subject."\r\n\r\n";
  $body .= "ИМЯ:\r\n".$na."\r\n\r\n";
...
{ 
  $subject = '=?UTF-8?B?'.base64_encode('Банковская гарантия для государственного контракта').'?=';
...
<a href="http://www.vekscon.ru"><div id="glav"></div></a><div id="textraz"><span class="mail">ОФОРМЛЕНИЕ ЗАЯВКИ НА БАНКОВСКУЮ ГАРАНТИЮ</span><br /><br />
...
<br /><br />Наименование организации<br>
	...
	<tr>
      <td align="left">Размер обеспечения исполнения обязательств<br><input type="text" name="org" maxlength="64" value="<?php echo $org ?>" /></td>
    </tr>
	<tr>
      <td>Дата заключения госконтракта<br><input type="text" name="kon" maxlength="64" value="<?php echo $kon ?>" /> </td>
    </tr>
	<tr>
      <td>Интернет ссылка на конкурс<br><input type="text" name="ssilka" maxlength="64" value="<?php echo $ssilka ?>" /></td>
    </tr>
	<tr>
      <td align="left">или проект Госконтракта (тендерная документация)<br><input type="file" name="file" /><br><br />
	  </td>
    </tr>
	</table></td>
    <td>&nbsp;</td>
...
<a href="zayavlenie_na_okazanie_uslug_bg.doc"><div id="nizr2"></div></a>
</div>
</div>
</body>
</html>
